 ...
 */
public class WarcOutputFormat extends FileOutputFormat<LongWritable, ArcRecord> {

    @Override
    public RecordWriter<LongWritable, ArcRecord> getRecordWriter(TaskAttemptContext tac) throws IOException, InterruptedException {
    ...
    public class WarcRecordWriter extends RecordWriter<LongWritable, ArcRecord> {
        ...
        @Override
        public void write(LongWritable k, ArcRecord arcRecord) throws IOException, InterruptedException {
