 ...
 * @author onbscs
 */
public class TikaCliOptions extends CliOptions {

    @Override
    public String getUsage() {
        return "(java -jar|hadoop jar) hawarp/tika-identify/target/droid-identify-1.0-jar-with-dependencies.jar";
    }
    
    public TikaCliOptions() {
        super();
    ...
    public void initOptions(CommandLine cmd, TikaCliConfig pc) {
